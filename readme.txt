...
Запустить скрипт "./model_training_batchify_clean.py PATH_TO_TRAIN PATH_TO_VALID MODEL_NAME", где PATH_TO_TRAIN - путь к train'у; PATH_TO_VALID - пусть к valid'у; MODEL_NAME - имя сохраняемой модели (в /models)
